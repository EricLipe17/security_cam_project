...
Demuxer::Demuxer(const char *_pFn, AVDictionary *_pOpts)
    : m_pInFmtCtx{nullptr}, m_pFn{_pFn}, m_pOpts{_pOpts},
      m_vDecCodecCtxs{nullptr, nullptr}, m_vDecFrames{nullptr, nullptr},
      m_nErrCode{0} {
  openInput();
}
...
void Demuxer::openInput() {
  ...
  for (nStreamIndex = 0; nStreamIndex < m_pInFmtCtx->nb_streams;
       nStreamIndex++) {
